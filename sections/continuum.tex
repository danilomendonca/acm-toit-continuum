...
During the journey of our user, her AV passes by a touristic area. The mobile-edge stations covering this area feature services to be consumed by an AR application for guiding tourists. In particular, these services have to share resources with those consumed by autonomous vehicles passing by this area.
