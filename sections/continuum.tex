...
During its journey home, our user's AV passes by a touristic region. The mobile-edge stations covering this region also feature services to be consumed by an AR application for guiding tourists. In particular, these services have to share resources with those consumed by autonomous vehicles passing by this area, as well as any other services deployed to these mobile-edge stations.
