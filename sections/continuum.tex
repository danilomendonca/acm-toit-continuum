...
Last but not least, conventional cloud infrastructure provide stateful services (e.g., multimedia storage, game authentication, player scores, etc).% and persistence (e.g., player scores).  
