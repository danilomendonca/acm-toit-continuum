...
From the provider's viewpoint, the awareness phase models the discovery of continuum applications in one of its domains' coverage area, indicating the imminent need for the corresponding $\mu$-services. 
...
Throughout Allocation, the mobile middleware handles the following events:
