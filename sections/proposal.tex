...
To realize this activity, exploits a self-management loop~\cite{kephart2003vision} (see Sec.~\ref{sec:ps_allocation}) in which the domain manager allocates resources (i.e., containers) to guarantee that latency and availability of each provided $\mu$-service cope with its SLA. Throughout Allocation, the domain manager deals with the following events:
