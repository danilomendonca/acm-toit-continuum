...
From the client's perspective, Awareness corresponds to the discovery of domains followed by a \textit{client identification} signal. To realize it, cloud domains can rely on special purpose HTTP endpoints for handshaking, whereas local-edge and mobile-edge domains can respectively rely on local area and radio access network protocols.
