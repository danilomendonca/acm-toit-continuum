...
\begin{figure}[htbp]
	...
	\subfloat[Different phases of the A3-E model; phases are delimited by vertical lines and the main activity of each phase by the label within each phase; labels within parenthesis represent the states of a domain (client) with respect to a client (domain)\label{fig:cloud-to-edge}]{ \includegraphics[width=0.9\textwidth]{figs/A3-E.png}}\hfill
