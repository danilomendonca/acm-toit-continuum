...
\begin{figure}[tbp]
	...
	\caption{The high level architecture of a mobile application exploiting both the computing continuum -- by means of microservices ($\mu$S) -- and conventional cloud computing -- by means of cloud services (CS).}
