...
%TODO [Danilo] I think the running example would be better placed here, after the model has been presented. Then we can describe each application using the concepts in the model and point to the challenges in the managing the life-cycle of continuum services
