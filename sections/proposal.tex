...
\begin{itemize}
	...
	\item \textbf{Request arrived:} indicates the arrival of a request for a specific $\mu$-service. The manger must handle the event with the allocation of the request to an service instance. %TODO [Danilo] Sounds like load balancing; is it so?
