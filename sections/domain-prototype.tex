...
%In particular, the prototype implements:
...
After fetching the software artifacts from the repository, the \textit{AcquisitionManager} searches for a service descriptor that specifies the function(s), which are then automatically built (step 4) along with their dependencies by means of Gradle\footnote{\url{https://gradle.org/}}.
