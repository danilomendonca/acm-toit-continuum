...
As shown in Table~\ref{tab:domain-exp-config}, our model was evaluated with four types of domains: mobile, local-edge, and cloud. The mobile domain was deployed to an Android smartphone hosting the A3-E middleware
%~\footnote{Implementation available in \url{https://github.com/deib-polimi/A3-E-DSM-mobile}}
 and a client application. More precisely, the latter emulates Augment Reality by invoking
