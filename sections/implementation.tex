...
For each domain, the algorithm computes the overall score (line $9$ to $14$). For each QoS, it normalizes the actual value with the previously computed maximum.
