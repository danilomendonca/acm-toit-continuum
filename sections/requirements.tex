...
\begin{figure}[tbp]
	...
	\hfill
	\subfloat[The heterogeneity of different compute platforms and infrastructures abstracted as domains\label{fig:edge-domain-client}] {\includegraphics[width=0.45\textwidth]{figs/edge-domain-client.png}}
	\hfill\null
