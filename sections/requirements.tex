...
The continuum encompasses distinct types of computational resources located at the cloud and at the edge of the network, as well as in mobile devices (Fig.~\ref{fig:continuum-scenario}). Accordingly, the unified model should be: agnostic with respect to the capabilities and specific technology details of different computing platforms and infrastructures in the continuum (\stepcounter{req_sub_count}\textbf{R\arabic{req_count}.\arabic{req_sub_count}}); and flexible, so that different instances of the model can address the many particularities in the continuum (\stepcounter{req_sub_count}\textbf{R\arabic{req_count}.\arabic{req_sub_count}}).
...
Finally, in order to materialize the computational continuum, the fine grained distribution of edge datacenters has to be managed in an automated way to avoid the burden and costs of manual human operation. This encompasses the operational aspects of deployment and maintenance, including the allocation of resources for different services in the context of a shared platform (\stepcounter{req_sub_count}\textbf{R\arabic{req_count}.\arabic{req_sub_count}}) and the installation of services to heterogeneous servers in the continuum (\stepcounter{req_sub_count}\textbf{R\arabic{req_count}.\arabic{req_sub_count}}).
