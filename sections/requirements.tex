...
\begin{itemize}
	...
	\stepcounter{req_count}
	\item The priority of the usage of computational resources from edge-domains must be in accordance with the application category and its QoS requirements (\textbf{R\arabic{req_count}})
\end{itemize}
