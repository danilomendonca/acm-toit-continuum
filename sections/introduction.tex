...
To reduce network latency, data must be processed closer to where it is produced and consumed. In accordance with this principle, the emerging paradigm of edge computing~\cite{} states that computing power should be pushed from centralized datacenters to the edge of the network. The realization of this paradigm, however, still poses many challenges:
...
In this paper, we propose A3-E, a unified model for the computation continuum formed by cloud, edge, and mobile computing. The proposed model is based on the serverless computing paradigm. In specific, A3-E explores the FaaS model to allow stateless functions to be quickly deployed and exposed as services, proving and efficient and scalable allocation of resources. A3-E further extends FaaS with the complete automation of the execution life-cycle, including the acquisition and installation of service artifacts by servers. Such an autonomy releases developers and administrators from the burden of deployment and maintenance.
