...
The realization of the cloud-edge-mobile continuum encompasses two main challenges: the materialization of edge computing, whose particular characteristics require an \textit{automated} and \textit{efficient} management and provisioning of its resources; and also the mechanisms that allow computation to be seamlessly displaced among heterogeneous parts of the continuum according to the contexts of operation. % including both the context of clients and service providers.
